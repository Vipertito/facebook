    ...
    return (
        <div className="Main">
            <div className="Rside">
                <div className="Profile">
                    <img src="4.jpg" alt="dp" style={{height:"50px",padding:"1rem"}}/>
                    Mainak Banerjee
                </div>
                <div className="Pro">
                ...
                <div className="Profiles">
                    <img src="5.jpg" alt="logo" style={{height:"35px",padding:"1rem"}}/>
                    React Developer
                </div>
                <div className="Profiles">
                    <img src="2.jpg" alt="logo" style={{height:"35px",padding:"1rem"}}/>
                    MEAN STACK
                </div>
                <div className="Profiles">
                    <img src="3.jpg" alt="logo" style={{height:"35px",padding:"1rem"}}/>
                    JavaScript
                </div>
                <div className="Profiles">
                    <img src="6.jpg" alt="logo" style={{height:"35px",padding:"1rem"}}/>
                    React Developer
                </div>
                <div className="Pross">
            ...
            <div className="MainArea">
                <div className="addStory">
                    <div className="Story">
                        <img src="4.jpg" alt="IMG" style={{height:"60px",width:"60px",borderRadius:"60%"}}/>
                        <br></br>
                        <br></br>
                        <br></br>
                        <br></br>
                    ...
                    <div className="Story">
                        <img src="7.jpg" alt="IMG" style={{height:"60px",width:"60px",borderRadius:"60%"}}/>
                        <br></br>
                        <br></br>
                        <br></br>
                        <br></br>
                    ...
                    <div className="Story">
                        <img src="8.jpg" alt="IMG" style={{height:"60px",width:"60px",borderRadius:"60%"}}/>
                        <br></br>
                        <br></br>
                        <br></br>
                        <br></br>
                    ...
                    <div className="Story">
                        <img src="9.jpg" alt="IMG" style={{height:"60px",width:"60px",borderRadius:"60%"}}/>
                        <br></br>
                        <br></br>
                        <br></br>
                        <br></br>
                    ...
                    <div className="Story">
                        <img src="10.jpg" alt="IMG" style={{height:"60px",width:"60px",borderRadius:"60%"}}/>
                        <br></br>
                        <br></br>
                        <br></br>
                        <br></br>
                    ...
                    <div className="message">
                        ...
                        <div className="Posted">
                            <div className="poster">
                                <div className="Minee">
                                    <img src="3.jpg" alt="img" style={{height:"50px",widows:"50px",borderRadius:"50%"}}/>
                                    Minee
                            ...
                            <div className="FacebookImg">
                                <img src="1.jpg" alt="dp" style={{height:"auto",width:"100%"}}/>
                            </div>
        ...
        <div className="concise">
            <div className="Profilee">
                <img src="4.jpg" alt="logo" style={{height:"35px",padding:"1rem"}}/>
                Mainak Banerjee
            </div>
            <div className="Profilee">
                <img src="5.jpg" alt="logo" style={{height:"35px",padding:"1rem"}}/>
